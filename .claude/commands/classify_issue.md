...
- Respond with `/templates:chore` if the issue is a chore.
- Respond with `/templates:bug` if the issue is a bug.
- Respond with `/templates:feature` if the issue is a feature.
